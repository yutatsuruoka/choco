...
?>
    ...
    <div class="girl_2nd wrapper" id="girl_2nd_fb">
        ...
        <article>
            ...
            <button onclick="javascript:return changeList(document.forms['User'].fbname, lists['all']); ">All</button>
            <button onclick="javascript:return changeList(document.forms['User'].fbname, lists['male']); ">Male</button>
            <button onclick="javascript:return changeList(document.forms['User'].fbname, lists['female']); ">Female</button>
