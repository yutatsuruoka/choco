...
<body>
    ...
    <div class="headerContainer wrapper">
        <header>
        <h1><a href="index.html"><img src="<?php echo $this->webroot ?>i_sp/logo.png" width="300" height="28" alt="neda.ly + chocokure white day ver."></a></h1>
        </header>
    </div><!-- end wrapper -->
    ...
    <div class="onedariContainer wrapper">
        <div class="onedari_girl onedari">
            ...
            <ul class="twList clearfix">
                <li><a href="#"><img src="<?php echo $this->webroot ?>i_sp/onedari_icon.jpg" alt=""></a></li>
                <li><a href="#"><img src="<?php echo $this->webroot ?>i_sp/onedari_icon.jpg" alt=""></a></li>
                <li><a href="#"><img src="<?php echo $this->webroot ?>i_sp/onedari_icon.jpg" alt=""></a></li>
                <li><a href="#"><img src="<?php echo $this->webroot ?>i_sp/onedari_icon.jpg" alt=""></a></li>
                <li class="last"><a href="#"><img src="<?php echo $this->webroot ?>i_sp/onedari_icon.jpg" alt=""></a></li>
                <li><a href="#"><img src="<?php echo $this->webroot ?>i_sp/onedari_icon.jpg" alt=""></a></li>
                <li><a href="#"><img src="<?php echo $this->webroot ?>i_sp/onedari_icon.jpg" alt=""></a></li>
                <li><a href="#"><img src="<?php echo $this->webroot ?>i_sp/onedari_icon.jpg" alt=""></a></li>
                <li><a href="#"><img src="<?php echo $this->webroot ?>i_sp/onedari_icon.jpg" alt=""></a></li>
