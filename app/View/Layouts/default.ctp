...
<head>
 ...
 <body id="<?php echo $html_body_id ?>" <?php if ($html_body_id == 'contentsFlow07' && empty($ppErrors) > 0) echo "onLoad=\"document.forms['gateway_form'].submit();\""; ?>>
    ...
    <div class="wrapper">
        ...
        <div class="snsButton left">
            <div id="fb-root"></div>
            <iframe src="//www.facebook.com/plugins/like.php?href=http%3A%2F%2Fwww.facebook.com%2Fnedaly.warusou&amp;send=false&amp;layout=button_count&amp;width=125&amp;show_faces=false&amp;action=like&amp;colorscheme=light&amp;font&amp;height=21&amp;appId=149485031807635" scrolling="no" frameborder="0" style="border:none; overflow:hidden; width:125px; height:21px;" allowTransparency="true"></iframe>
        </div><!-- end .snsButton-->
