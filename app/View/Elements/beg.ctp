    <div class="top wrapper">
        ...
        <p class="price">¥<?php echo $product[0]["Product"]['price'] ?><span>バスグッズ等のセットとなります。<br>　　　　 ※17時迄の注文は当日から3営業日以内の発送となります。</span></p>
        ...
        <h2><?php echo $product[1]["Product"]['name'] ?></h2>
        <p class="price">¥<?php echo $product[1]["Product"]['price'] ?><span>フルーツや花の香を閉じ込めたラグジュアリーなスプマンテ<br>　　　　 ※17時迄の注文は当日から3営業日以内の発送となります。</span></p>
        <ul class="onedariContainer clearfix">
            ...
            <li class="right fb"><a href="<?php echo $this->webroot ?>Posts/add/5"><img src="<?php echo $this->webroot ?>i/present_fbbtn.jpg" alt="Facebookでおねだり"></a></li>
        </ul>
        </section>
        <section class="present last">
        <img src="<?php echo $this->webroot ?>i/present_60.jpg" alt="Pruduct name">
        <h2>超高いものComing Soon!!</h2>
        <p class="price"><span>　<br>　</span></p>
        <ul class="onedariContainer clearfix">
