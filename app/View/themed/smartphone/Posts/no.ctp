    <div class="contents wrapper" id="flow06_kyohi">
        ...
        <p>おねだりを断ると <a href="">Neo Iida</a> さんに嫌われる可能性があります。
        それでも本当におねだりを断りますか？</p>
        </section>
        ...
        <ul class="onedariBtn clearfix">
            <li class="left tw"><a href="<?php echo $this->webroot ?>Payment/nono/">▶ 僕はケチだから断る</a></li>
            <li class="right fb"><a href="<?php echo $this->webroot ?>Payment/">▶ やっぱりプレゼント！</a></li>
        </ul>
        </section>
        </article>
